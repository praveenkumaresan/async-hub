...
In this example:
The CoroutineExample class has a method execute that uses runBlocking to start a coroutine.
Inside runBlocking, a coroutine is launched that delays for 1 second and then prints a message.
The main function creates an instance of CoroutineExample and calls the execute method.
