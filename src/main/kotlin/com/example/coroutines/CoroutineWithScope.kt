...
In this example:
The com.example.CoroutineScopeExample class implements CoroutineScope and defines a Job and Dispatcher for the coroutine context.
...
The main function creates an instance of com.example.CoroutineScopeExample, calls the execute method, and waits for the coroutine to complete before calling cleanup.
