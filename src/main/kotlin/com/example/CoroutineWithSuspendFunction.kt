...
In this example:
The com.example.SuspendFunctionExample class has a suspend function longRunningTask that delays for 1 second and then prints a message.
The execute method uses runBlocking to start a coroutine that calls the longRunningTask function.
The main function creates an instance of com.example.SuspendFunctionExample and calls the execute method.
